...
\author{Emanuele Di Marco,\footnote{\href{mailto:emanuele.dimarco@roma1.infn.it}{emanuele.dimarco@roma1.infn.it}} \\
  {Daniele del Re,\footnote{\href{mailto:daniele.delre@uniroma1.it}{daniele.delre@iniroma1.it}} }
  }
\date{\today}
...
%\input{esercitazione-04}
%\input{esercitazione-05}
%\input{prova-itinere-01-28-04-2021.tex}
%\input{esercitazione-06}
%\input{esercitazione-07}
%\input{esercitazione-08}
%\input{esercitazione-09}

\input{2022-esercitazione-02}
